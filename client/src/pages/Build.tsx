  ...
  return (
    <div className="container">
      <div className="card" style={{ maxWidth: '480px', margin: '0 auto', textAlign: 'left' }}>
        <h2 style={{ color: ui.color.text, marginTop: 0 }}>Build Info</h2>
        <dl style={{ fontSize: '14px', lineHeight: 1.6 }}>
          <dt style={{ color: ui.color.textMuted }}>Built at</dt>
          <dd style={{ margin: '0 0 12px', fontFamily: 'monospace' }}>{__BUILD_TIME__}</dd>

          <dt style={{ color: ui.color.textMuted }}>Commit</dt>
          <dd style={{ margin: '0 0 12px', fontFamily: 'monospace' }}>{__COMMIT_HASH__}</dd>

          <dt style={{ color: ui.color.textMuted }}>Commit message</dt>
